...
window.addEventListener("mse.update", e => {
  const d = (e && e.detail && e.detail.mse) || {};
  const set = (id, val) => { const el = document.getElementById(id); if (el) el.value = val || ""; };
  set("mse_appearance", d.appearance);
  set("mse_behavior", d.behavior);
  set("mse_speech", d.speech);
  set("mse_mood", d.mood);
  set("mse_affect", d.affect);
  set("mse_thought_process", d.thoughtProcess);
  set("mse_thought_content", d.thoughtContent);
  set("mse_cognition", d.cognition);
  set("mse_insight", d.insight);
  set("mse_judgment", d.judgment);
  console.debug("MSE populated", d);
});
