...
(() => {
  function getText(sel){try{var el=document.querySelector(sel);if(!el)return "";var t="";if("value" in el && el.value!=null)t=String(el.value);else t=String(el.textContent||"");return t.trim();}catch(e){return "";}}
...
/* override: null-safe getText */
if (typeof window.getText === "function") {
  try {
    window._orig_getText = window.getText;
  } catch(e){}
}
function getText(sel){
  try{
    ...
    if (!el) return "";
    var t = "";
    if ("value" in el && el.value != null) t = String(el.value);
